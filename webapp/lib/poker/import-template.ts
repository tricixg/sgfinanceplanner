...
/** Example tournament row (no Account — safe to upload as-is). */
export const POKER_IMPORT_EXAMPLE_TOURNAMENT_ROW =
  "tournament,2026-05-10T14:00,Resorts World,500,,USD,1.35,true,8,Day 1,,,,,APT,Main Event,placed,1200,8,200,,";
